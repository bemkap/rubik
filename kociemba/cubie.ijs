...
MPc=: |:"2]_2((AXIS i. {.),((".&>)@:{:))\"1;:&>cutLF(0 : 0)
 u 1 r 0 f 0 d 0 l 0 b 0
 u 0 r 1 f 0 d 0 l 0 b 0
 u 0 r 0 f 1 d 0 l 0 b 0
 u 0 r 0 f 0 d 1 l 0 b 0
 u 0 r 0 f 0 d 0 l 1 b 0
 u 0 r 0 f 0 d 0 l 0 b 1
 u 1 r 0 f 0 d 3 l 0 b 0
 u 0 r 1 f 0 d 0 l 3 b 0
 u 0 r 0 f 1 d 0 l 0 b 3
 u 1 r 0 f 0 d 3 l 0 b 0 
 u 0 r 1 f 0 d 0 l 3 b 0 
 u 0 r 0 f 1 d 0 l 0 b 3 
)
