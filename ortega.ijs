...
CPM=: ;:'rrffrr rUfuuFuR RuRbbrUr rruffuurrurr ffUrURuffuruR rUrffRurffrr zzrUrffRurffrrzz'
CPP=: 0 1 16 17 15 31 241
...
st3=: 3 : 0
 ...
 y=. z{~j=. 1 i.~ 7>CPP i. i
 y=. y sper CPM{::~CPP i. j{i
 sper&'d'^:(1~:13&gface)^:_ sper&'u'^:(1~:8&gface)^:_ y
)
NB. stage 4: 3 top edges
TEM=:     ;:'UleLulEL uU uleLUlEL uuleLuulEL leLEfflELff llellEfflELff LelEfflELff fflELff FelELf elEL felELF ffelELff'
TEM=: TEM,;:'RlELr lEL uureRuu rrlELrr BleeLb leeL bleeLB bbleeLbb DLeldlEL LellEL dLelDlEL ddLelddlEL'
